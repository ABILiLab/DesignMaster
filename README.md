...
**DesignMaster** is a diffusion-based generative framework for **multi-conditional PROTAC linker design**. The model explicitly incorporates **linker length and physicochemical properties** as controllable conditioning signals, enabling fine-grained and constraint-aware generation of PROTAC molecules.
